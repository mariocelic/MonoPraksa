...
namespace MonoPraksa.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public DepartmentsController(PraksaContext context)
        {
            _context = context;
        }
        ...
        {
            var praksaContext = _context.Departments.Include(d => d.Administrator);
            return View(await praksaContext.ToListAsync());
        }
